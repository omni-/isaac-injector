...
FuncSignature Signature_GameUpdate = {
	"\x55\x8b\xec\x83\xec\x0c\x53\x8b\x1d\x00\x00\x00\x00\x56\x57\x8d\x83\x10\xb0\x02\x00\x50"
	"\x89\x5d\xf8\xe8\x00\x00\x00\x00\x8b\x83\x68\xe2\x12\x00\x85\xc0\x7e\x00\x48\x89\x83\x68"
	"\xe2\x12\x00",
	// mask
...
FuncSignature Signature_PlayerUpdate = {
	...
	"\x00\x00\x00\x00\xa1\x00\x00\x00\x00\x33\xc4\x89\x84\x24\x38\x01\x00\x00\x53\x56\x57\xa1"
	"\x00\x00\x00\x00\x33\xc4\x50\x8d\x84\x24\x50\x01\x00\x00\x64\xa3\x00\x00\x00\x00\x8b\xd9"
	"\x89\x5c\x24\x30\xc7\x44\x24\x14\x00\x00\x00\x00",
	// mask
	"xxxxxxxxx????xx????xxx????x????xxxxxxxxxxxxx????xxxxxxxxxxxx????xxxxxxxxxxxxxx",
	// size
...
// Before switch()
FuncSignature Signature_UseCardEvent = {
	"\x83\xf8\x27\x0f\x87\x00\x00\x00\x00\xff\x24\x85\x00\x00\x00\x00\x8b\x83\x70\x0b\x00\x00"
	"\x85\xc0\x75\x00\xb8\x00\x00\x00\x00\x50",
	// mask
	"xxxxx????xxx????xxxxxxxxx?x????x",
	// size
	strlen(Signature_UseCardEvent.mask)
};

FuncSignature Signature_GotoFloorEvent = {
	"\x51\x56\x57\x8b\x3d\x00\x00\x00\x00\x50\x51\x8d\xb7\x44\x94\x00\x00\xe8\x00\x00\x00\x00"
	"\x8b\x97\x9c\x94\x00\x00\x2b\x97\x98\x94\x00\x00\x33\xf6\xc1\xfa\x02\x85\xd2\x74\x00\xeb"
	"\x00\x8d\x49\x00\x8b\x87\x9c\x94\x00\x00",
	// mask
	"xxxxx????xxxxxxxxx????xxxxxxxxxxxxxxxxxxxx?x?xxxxxxxxx",
	// size
...
FuncSignature Signature_PlayerHitsEnemyEvent = {
	"\x55\x8b\xec\x83\xe4\xf8\x81\xec\x00\x00\x00\x00\x8b\x45\x08\x8b\x50\x0c\x53\x56\x57\x8b"
	"\xf9\x89\x7c\x24\x0c\x89\x54\x24\x1c\x83\xfa\x0a\x7c\x00\x81\xfa\x00\x00\x00\x00\x7d\x00"
	"\x8b\x88\x28\x03\x00\x00\x83\xf9\x01\x74\x00\x85\xc9\x74\x00\x80\xb8\x60\x04\x00\x00\x00"
	"\x75\x00\x80\xb8\x0f\x03\x00\x00\x00\x75\x00\x8b\x88\x08\x03\x00\x00\xc1\xe9\x04\xf6\xc1"
	"\x01\x74\x00",
	// mask
	"xxxxxxxx????xxxxxxxxxxxxxxxxxxxxxxx?xx????x?xxxxxxxxxx?xxx?xxxxxxxx?xxxxxxxx?xxxxxxxxxxxxx?",
	// size
	strlen(Signature_PlayerHitsEnemyEvent.mask)
};
